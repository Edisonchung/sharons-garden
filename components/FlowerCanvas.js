    ...
    <div className="relative">
      <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-4 justify-center mt-6">
        {flowers.map((flower) => (
          <div
            key={flower.id}
            className="flex items-center justify-center w-16 h-16 rounded-lg shadow bg-white dark:bg-gray-800 hover:scale-105 transition-transform cursor-pointer"
        ...
        >
          ...
          >
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-4">
              Watered {selected.waterCount} / 7 times
            </p>
            {!selected.bloomed && (
              <button
